...
# --- (هنا بقية الكود الخاص بالبوت كما هو بدون تغيير) ---
# ... (كل دوال البوت من fetch_data, calculate_indicators, check_strategy, send_signal, etc.)
# ... (سأضع الكود الكامل في النهاية لتجنب التكرار هنا)
...
def main() -> None:
    ...
    if not all([TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID, API_KEY_1, API_KEY_2]):
        ...
        # لا يمكن إرسال رسالة تليجرام هنا لأن التوكن قد يكون مفقودًا
        return 
